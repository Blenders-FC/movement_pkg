...
#ifndef LEFT_SEARCH_GOAL_ACTION_H
#define LEFT_SEARCH_GOAL_ACTION_H
...
namespace BT
{
class LeftSearchGoal : public ActionNode, public CBDataManager
{
    public:
        // Constructor
        explicit LeftSearchGoal(std::string name);
        ~LeftSearchGoal();
...
#endif  // LEFT_SEARCH_GOAL_ACTION_H

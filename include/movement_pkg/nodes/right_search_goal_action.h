...
#ifndef RIGHT_SEARCH_GOAL_ACTION_H
#define RIGHT_SEARCH_GOAL_ACTION_H
...
namespace BT
{
class RightSearchGoal : public ActionNode, public CBDataManager
{
    public:
        // Constructor
        explicit RightSearchGoal(std::string name);
        ~RightSearchGoal();
    ...
    private:
        ...
        void writeHeadJoint(double ang_valueX);
...
#endif  // RIGHT_SEARCH_GOAL_ACTION_H

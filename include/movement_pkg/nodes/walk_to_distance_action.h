...
#ifndef WALKING_TO_DISTANCE_ACTION_H
#define WALKING_TO_DISTANCE_ACTION_H
...
namespace BT
{
class WalkToDistance : public ActionNode, public WalkingController, public CBDataManager
{
    public:
        // Constructor
...
#endif  // WALKING_TO_DISTANCE_ACTION_H
